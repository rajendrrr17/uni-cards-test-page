    ...
    <div className="bodyContainer">
      <div className="leftBody">
        ...
        <span className="benefits">
          1% Cashback <span className="star">*</span> 5x Rewards{" "}
          <span className="star">*</span> Zero Forex Markup
        </span>
        <div className="inputAndApplyNow">
          <input
        ...
        <div className="termsAndCondition">
          <input type="checkbox" />
          <label className="termsAndConditionLabel">
