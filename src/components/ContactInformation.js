    ...
    <div className="contactInfoWrapper">
      <div className="contactInfoDetails">
        ...
        <div className="addressWrapper">
          ...
          <span className="address">Contact Us: 080 68216821</span>
          <span>Email: care@uni.club</span>
        </div>
        <hr className="horizontalLine" />
        <div className="bankInfoWrapper">
          <span className="bankInfo">
            Grievance Redressal Mechanism - SBM Bank India
          </span>
          <span className="bankInfo">CSR Policy</span>
        </div>
        <hr className="horizontalLine" />
        <div className="listSyles">
        <ul>
          <li>
            Instagram
          </li>
